/*
로컬 회원가입을 했을 때에는, 전달받은 비밀번호를 해싱하여 password 값으로 저장하고, 소셜 계정 로그인을 했을 때에는, 
로그인을 할 때 각 소셜 서비스에서 회원을 구분하기위해서 제공해주는 id 값과, 
해당 계정의 정보를 가져올때 필요한 accessToken 값을 데이터에 저장합니다.
